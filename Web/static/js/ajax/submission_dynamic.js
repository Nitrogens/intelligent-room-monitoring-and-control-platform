...
function changeToPage(new_page_id) {
    page_id = new_page_id;
    $.ajax({
        url: '/api/submission/',
        dataType: 'json',
...
$("#previous-page, #current-page-minus-1").click(function () {
    changeToPage(page_id - 1);
});

$("#next-page, #current-page-plus-1").click(function () {
    changeToPage(page_id + 1);
});

$("#current-page-minus-2").click(function () {
    changeToPage(page_id - 2);
});

$("#current-page-plus-2").click(function () {
    changeToPage(page_id + 2);
});

$(document).ready(function () {
    changeToPage(page_id);
});